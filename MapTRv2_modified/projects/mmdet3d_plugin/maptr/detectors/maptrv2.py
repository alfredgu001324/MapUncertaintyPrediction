...
class MapTRv2(MVXTwoStageDetector):
    ...
    def pred2result(self, bboxes, scores, labels, pts, betas, attrs=None):
    ...
    def simple_test_pts(self, x, lidar_feat, img_metas, prev_bev=None, rescale=False):
        ...
        bbox_results = [
            self.pred2result(bboxes, scores, labels, pts, betas)
            for bboxes, scores, labels, pts, betas in bbox_list
        ]
        # import pdb;pdb.set_trace()
