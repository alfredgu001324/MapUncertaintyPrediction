...
class NuscenesDataModule(LightningDataModule):
    ...
    def prepare_data(self) -> None:
        NuscenesDataset(self.root, 'train', self.train_transform, self.local_radius, self.centerline_used)
        NuscenesDataset(self.root, 'val', self.val_transform, self.local_radius, self.centerline_used)
